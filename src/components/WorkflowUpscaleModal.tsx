...
import { X, MessageCircle, ArrowUpRight, Play, CheckCircle2, Sparkles, Cpu } from 'lucide-react';
        ...
        >
          ...
          >
            ...
            <div className="relative flex items-start justify-between gap-4 pb-4 border-b border-rose-500/20">
              <div className="space-y-1.5">
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-[11px] font-mono font-bold text-pink-300 bg-pink-950/90 border border-pink-500/40">
            ...
            <div className="relative mt-5 rounded-xl overflow-hidden border border-rose-500/30 bg-black/90 shadow-[0_0_25px_rgba(0,0,0,0.8)] aspect-video">
              <iframe
                id="odysee-iframe"
                src="https://odysee.com/%24/embed/%40CREKONI%3A9%2Fnordy-gera-5-fotos%3Acd2d6d18fa?r=Du1MScs2qhpenuh9fhkyZkv5jEoUpS1d"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5 mt-4">
              <div className="p-3 rounded-lg bg-rose-950/30 border border-rose-500/20 text-xs">
                ...
                <p className="text-slate-400 text-[11px] leading-normal">
                  Mantém a identidade facial, olhar e traços reais da modelo com fidelidade incomparável.
                </p>
              </div>
              ...
              <div className="p-3 rounded-lg bg-rose-950/30 border border-rose-500/20 text-xs">
                <div className="flex items-center gap-1.5 text-pink-300 font-semibold mb-1">
                  ...
                  5 Imagens Sem Censura
                </div>
                <p className="text-slate-400 text-[11px] leading-normal">
                  Cria 5 variações +18 perfeitas e hiper-realistas da modelo em um único ciclo de execução.
                </p>
              </div>
