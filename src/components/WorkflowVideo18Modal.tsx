...
import { X, MessageCircle, ArrowUpRight, ShieldAlert, Play, CheckCircle2, Flame, Video } from 'lucide-react';
      ...
      {isOpen && (
        ...
        >
          ...
          <motion.div
            ...
            className="relative w-full max-w-3xl rounded-2xl bg-[#0f0e1c] border border-cyan-500/40 shadow-[0_0_50px_rgba(6,182,212,0.25)] p-5 sm:p-7 z-10 my-auto text-left"
          >
            ...
            <div className="relative flex items-start justify-between gap-4 pb-4 border-b border-cyan-500/20">
              <div className="space-y-1.5">
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-[11px] font-mono font-bold text-rose-300 bg-rose-950/90 border border-rose-500/40">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5 mt-4">
              <div className="p-3 rounded-lg bg-cyan-950/30 border border-cyan-500/20 text-xs">
                ...
                <p className="text-slate-400 text-[11px] leading-normal">
                  Crie vídeos com nitidez cristalina, iluminação dinâmica e fidelidade corporal da sua modelo.
                </p>
              </div>
              ...
              <div className="p-3 rounded-lg bg-cyan-950/30 border border-cyan-500/20 text-xs">
                ...
                <p className="text-slate-400 text-[11px] leading-normal">
                  Controle total sobre movimentos, cenas e ângulos sem censura com parâmetros pré-ajustados.
                </p>
              </div>
              ...
              <div className="p-3 rounded-lg bg-cyan-950/30 border border-cyan-500/20 text-xs">
                ...
                <p className="text-slate-400 text-[11px] leading-normal">
                  Importação imediata no RunningHub com suporte direto via WhatsApp para instalação e uso.
                </p>
              </div>
            </div>
            ...
            <div className="mt-6 pt-4 border-t border-cyan-500/20 flex flex-col sm:flex-row items-center justify-between gap-3">
              <div className="text-center sm:text-left">
                ...
                <p className="text-xs text-slate-400 mt-0.5">
                  Fale com a gente diretamente no WhatsApp e receba o fluxo completo.
                </p>
              </div>
