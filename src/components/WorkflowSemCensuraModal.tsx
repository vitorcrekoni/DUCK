...
import { X, MessageCircle, ArrowUpRight, ShieldAlert, Play, CheckCircle2, Flame } from 'lucide-react';
      ...
      {isOpen && (
        ...
        >
          ...
          <motion.div
            ...
            className="relative w-full max-w-3xl rounded-2xl bg-[#140a0e] border border-rose-500/40 shadow-[0_0_50px_rgba(244,63,94,0.25)] p-5 sm:p-7 z-10 my-auto text-left"
          >
            ...
            <div className="relative flex items-start justify-between gap-4 pb-4 border-b border-rose-500/20">
              <div className="space-y-1.5">
                ...
                >
                  WORKFLOW MOTION SEM CENSURA +18
                </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5 mt-4">
              <div className="p-3 rounded-lg bg-rose-950/30 border border-rose-500/20 text-xs">
                <div className="flex items-center gap-1.5 text-rose-300 font-semibold mb-1">
                  ...
                  Cópia Anatômica Realista
                </div>
                <p className="text-slate-400 text-[11px] leading-normal">
                  Transfira movimentos e poses humanas complexas preservando as formas e texturas da sua modelo.
                </p>
              </div>
              ...
              <div className="p-3 rounded-lg bg-rose-950/30 border border-rose-500/20 text-xs">
                <div className="flex items-center gap-1.5 text-amber-300 font-semibold mb-1">
                  ...
                  Liberdade Sem Bloqueios
                </div>
                <p className="text-slate-400 text-[11px] leading-normal">
                  Workflow sem filtros restritivos para geração livre e personalizada com controle milimétrico.
                </p>
              </div>
              ...
              <div className="p-3 rounded-lg bg-rose-950/30 border border-rose-500/20 text-xs">
                ...
                <p className="text-slate-400 text-[11px] leading-normal">
                  Nós pré-configurados, modelos indicados e suporte direto via WhatsApp para tirar qualquer dúvida.
                </p>
              </div>
            </div>
